    ...
    return (
        <section id="trust" className="py-16 relative bg-brand-50/30">
            <div className="max-w-7xl mx-auto px-5 sm:px-8">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full lg:w-auto">
                        {trustItems.map((item, i) => (
                            <div key={i} className="glass-card !bg-white/40 p-6 rounded-[2rem] flex flex-col items-center lg:items-start text-center lg:text-left hover:bg-white transition-colors duration-300">
                ...
                <div className="mt-16 pt-12 border-t border-brand-100/50 flex flex-wrap items-center justify-center gap-10 lg:gap-20 opacity-30 grayscale contrast-125">
