            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    <motion.div variants={itemVars} className="lg:col-span-8 bg-white dark:bg-white/5 rounded-[3.5rem] p-12 border border-gray-100 dark:border-white/10 shadow-sm relative overflow-hidden group transition-colors">
                        <div className="relative z-10">
                            <h3 className="text-2xl font-black tracking-tighter mb-10 uppercase italic text-black dark:text-white flex items-center gap-4">
                                <Activity className="w-6 h-6" /> Liquidity Analysis
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                <div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="px-4 py-2 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[10px] font-black tracking-widest uppercase rounded-xl border border-emerald-500/20 flex items-center gap-2">
                                ...
                                <div className="space-y-6">
                                    {[
                                        ...
                                        <div key={i} className="p-6 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/10 group/item hover:border-black dark:hover:border-white transition-all">
                                            <div className="flex items-center justify-between mb-2">
                                                <item.icon className="w-5 h-5 text-gray-400 dark:text-white/20 group-hover/item:text-black dark:group-hover/item:text-white transition-colors" />
                    ...
                    <motion.div variants={itemVars} className="lg:col-span-4 space-y-8">
                        <div className="bg-black dark:bg-white text-white dark:text-black rounded-[3.5rem] p-10 shadow-2xl relative overflow-hidden group transition-colors">
                            <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent dark:from-black/10 opacity-50" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    {[
                        ...
                        <motion.div key={i} variants={itemVars} className="bg-white dark:bg-white/5 rounded-[3rem] p-10 border border-gray-100 dark:border-white/10 shadow-sm transition-colors group hover:border-black dark:hover:border-white">
                            <div className="w-12 h-12 bg-gray-50 dark:bg-white/5 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
